...
class AppStateNotifier extends ChangeNotifier {
  ...
  void update(MuallimFirebaseUser newUser) {
    initialUser ??= newUser;
    user = newUser;
    ...
    MWRoute(
      ...
      routes: [
        ...
        MWRoute(
          name: 'studentQaaidah',
          path: 'studentQaaidah',
          builder: (context, params) => StudentQaaidahWidget(
            page: params.getParam('page', ParamType.String),
            fontSize: params.getParam('fontSize', ParamType.int),
          ),
        ),
        MWRoute(
          name: 'adminHome',
        ...
        MWRoute(
          name: 'make',
          path: 'make',
          builder: (context, params) => MakeWidget(),
        ),
        MWRoute(
          name: 'studentNaazirah',
          path: 'studentNaazirah',
          builder: (context, params) => StudentNaazirahWidget(
            page: params.getParam('page', ParamType.String),
            fontSize: params.getParam('fontSize', ParamType.int),
          ),
        ),
