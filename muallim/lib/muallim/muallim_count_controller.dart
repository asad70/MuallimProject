...
class MuallimCountController extends StatefulWidget {
  const MuallimCountController({
    Key key,
  ...
  @override
  _MuallimCountControllerState createState() =>
      _MuallimCountControllerState();
}

class _MuallimCountControllerState
    extends State<MuallimCountController> {
